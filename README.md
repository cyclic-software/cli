...
cyclic-cli/0.0.10 darwin-x64 node-v14.15.2
$ cyclic --help [COMMAND]
USAGE
  $ cyclic COMMAND
...
...
_See code: [src/commands/bootstrap.ts](https://github.com/cyclic-software/cli/blob/v0.0.10/src/commands/bootstrap.ts)_
...
_See code: [src/commands/init-app.ts](https://github.com/cyclic-software/cli/blob/v0.0.10/src/commands/init-app.ts)_
...
_See code: [src/commands/login.ts](https://github.com/cyclic-software/cli/blob/v0.0.10/src/commands/login.ts)_
...
_See code: [src/commands/token.ts](https://github.com/cyclic-software/cli/blob/v0.0.10/src/commands/token.ts)_
<!-- commandsstop -->
